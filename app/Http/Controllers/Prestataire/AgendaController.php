...
class AgendaController extends Controller
{
        ...
        $recentServiceBookings = $prestataire->bookings()
            ...
            ->map(function($booking) {
                return [
                    ...
                    'can_accept' => $booking->status === 'pending', // Added for agenda actions
                    'can_reject' => $booking->status === 'pending', // Added for agenda actions
        ...
        $recentRentalRequests = EquipmentRentalRequest::where('prestataire_id', $prestataire->id)
            ...
            ->map(function($request) {
                return [
                    ...
                    'can_complete' => false,
                    'can_accept' => $request->status === 'pending', // Added for agenda actions
                    'can_reject' => $request->status === 'pending', // Added for agenda actions
    ...
    public function events(Request $request)
    {
        ...
        // Récupérer les demandes de location d'équipements (au lieu des locations actives)
        ...
        // Mapper les demandes de location d'équipements (au lieu des locations actives)
        $equipmentEvents = $equipmentRentalRequests->map(function ($rentalRequest) {
            ...
            return [
                ...
                'borderColor' => $color,
                'textColor' => '#ffffff',
                'allDay' => false, // Equipment rental requests can be time-specific
                'extendedProps' => [
