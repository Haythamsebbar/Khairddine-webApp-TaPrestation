                    ...
                    @auth
                        @if(auth()->user()->isClient())
                            <div class="flex flex-row gap-1 sm:gap-1.5">
                                ...
                                <a href="{{ route('client.messaging.start', $prestataire) }}" class="flex-1 inline-flex items-center justify-center px-1.5 py-1 bg-white text-blue-600 rounded-md text-xs font-semibold hover:bg-blue-50 transition-all duration-300 shadow-sm hover:shadow">
                                    <svg class="-ml-0.5 mr-1 h-2.5 w-2.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
