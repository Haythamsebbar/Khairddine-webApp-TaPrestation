                ...
                <div class="bg-white rounded-xl shadow-lg p-5 sm:p-6">
                    ...
                    <div class="space-y-4">
                        @forelse($prestataire->services->take(3) as $service)
                            <div class="service-card cursor-pointer" onclick="window.location='{{ route('services.show', $service) }}'">
                                <div class="p-4">
                                    <div class="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
                                        <!-- Image -->
                                        <div class="flex-shrink-0 w-full sm:w-24 h-32 sm:h-24 bg-gray-200 rounded-lg overflow-hidden">
                                            @if($service->image)
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                                                <div class="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2 mb-2 sm:mb-0">
                                                    <span class="item-badge service-badge">
                                                        Service
                                                    </span>
                ...
                <div class="bg-white rounded-xl shadow-lg p-5 sm:p-6">
                    ...
                    <div class="space-y-4">
                        @forelse(($prestataire->equipments ?? collect())->take(3) as $equipment)
                            <div class="equipment-card cursor-pointer">
                                <div class="p-4">
                                    <div class="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
                                        <!-- Image -->
                                        <div class="flex-shrink-0 w-full sm:w-24 h-32 sm:h-24 bg-gray-200 rounded-lg overflow-hidden">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                                                <div class="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2 mb-2 sm:mb-0">
                                                    <span class="item-badge equipment-badge">
                                                        Équipement
                                                    </span>
                                                    <h3 class="text-lg font-semibold text-gray-900">{{ $equipment->name }}</h3>
                                                </div>
                                                <span class="text-xs text-gray-500">{{ $equipment->created_at->diffForHumans() }}</span>
                                            </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-5 sm:p-6">
                    ...
                    <div class="space-y-4">
                        @forelse(($prestataire->urgentSales ?? collect())->take(3) as $sale)
                            <div class="sale-card cursor-pointer">
                                <div class="p-4">
                                    <div class="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
                                        <!-- Image -->
                                        <div class="flex-shrink-0 w-full sm:w-24 h-32 sm:h-24 bg-gray-200 rounded-lg overflow-hidden">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                                                <div class="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2 mb-2 sm:mb-0">
                                                    <span class="item-badge sale-badge">
                                                        Vente urgente
                                                    </span>
