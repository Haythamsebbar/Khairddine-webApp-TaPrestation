                    ...
                    @if($conversations->count() > 0)
                        @foreach($conversations as $conversation)
                            <div class="conversation-item border-b border-blue-100 last:border-b-0 hover:bg-blue-50 transition-colors cursor-pointer relative" 
                                 ...
                                 onclick="window.location.href='{{ Auth::user()->hasRole('client') ? route('client.messaging.show', $conversation['user']->id) : route('prestataire.prestataire.messages.show', $conversation['user']->id) }}'">
