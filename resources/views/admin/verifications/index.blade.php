...
<div class="bg-orange-50 min-h-screen">
    ...
    <div class="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <div class="max-w-7xl mx-auto">
            <div class="mb-6 sm:mb-8 text-center">
                <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-orange-900 mb-2 leading-tight">
                    Gestion des Vérifications
                </h1>
                <p class="text-base sm:text-lg text-orange-700 max-w-2xl mx-auto">
            ...
            <div class="text-center">
                <form action="{{ route('admin.verifications.run-automatic') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center text-sm sm:text-base mx-auto" onclick="return confirm('Lancer la vérification automatique pour tous les prestataires éligibles ?')">
                ...
                <div id="filtersContent" class="hidden lg:block">
                    <form method="GET" action="{{ route('admin.verifications.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                <label for="status" class="block text-sm font-medium text-orange-700 mb-2">Statut</label>
                                <select name="status" id="status" class="w-full px-3 py-2 border border-orange-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-white">
                            ...
                            <div>
                                <label for="document_type" class="block text-sm font-medium text-orange-700 mb-2">Type de document</label>
                                <select name="document_type" id="document_type" class="w-full px-3 py-2 border border-orange-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-white">
                            ...
                            <div>
                                <label for="search" class="block text-sm font-medium text-orange-700 mb-2">Rechercher</label>
                                <input type="text" name="search" id="search" class="w-full px-3 py-2 border border-orange-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" 
                                       placeholder="Nom du prestataire..." value="{{ request('search') }}">
                            </div>
                            <div class="flex items-end space-x-2">
                                <button type="submit" class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg transition duration-200 flex items-center">
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 mb-8">
        <div class="bg-white rounded-xl shadow-md border border-orange-200">
            <div class="p-4 sm:p-6">
                <h2 class="text-lg sm:text-xl font-bold text-orange-800 mb-6">Demandes de vérification</h2>
