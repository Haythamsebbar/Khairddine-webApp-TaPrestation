    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
        <div class="px-4 py-6 sm:px-6 sm:py-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <a href="{{ route('contact') }}" class="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-colors font-medium text-sm sm:text-base">
