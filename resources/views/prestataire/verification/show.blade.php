            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-4 sm:p-8 hover:shadow-xl transition-all duration-300">
                ...
                @if($verificationRequest->isPending())
                    <div class="text-center py-8">
                        <div class="flex items-center justify-center w-20 h-20 mx-auto mb-6 bg-orange-50 rounded-full">
                        ...
                        <div class="inline-flex items-center px-4 py-2 rounded-lg bg-orange-50 text-orange-800 text-sm font-medium">
