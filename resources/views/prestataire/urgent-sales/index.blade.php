    ...
    <div class="bg-white shadow-lg border-b-4 border-red-600">
        <div class="container mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-4xl font-bold text-red-900 mb-2">Mes Ventes Urgentes</h1>
                    <p class="text-red-700">Gérez vos ventes urgentes et opportunités</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow-lg border border-red-200 p-6 hover:shadow-xl transition duration-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-red-700">Total des ventes</p>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-red-200 hover:shadow-xl transition duration-200">
                    ...
                    <div class="relative">
                        @if($sale->photos && count($sale->photos) > 0)
                            <img src="{{ Storage::url($sale->photos[0]) }}" alt="{{ $sale->title }}" class="w-full h-48 object-cover rounded-t-xl">
                        @else
                        ...
                        <!-- Badge urgent -->
                        @if($sale->is_urgent)
                            <span class="absolute top-2 left-2 bg-red-600 text-white px-2 py-1 rounded-full text-xs font-semibold shadow-md">
