    ...
    @endif
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div class="dashboard-primary-card bg-white rounded-xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-300 flex flex-col min-h-[400px]">
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-red-600 mb-1">{{ $urgentSalesCount ?? 0 }}</div>
                        <div class="text-sm font-medium text-gray-600">Ventes actives</div>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-red-600 mb-1">{{ $urgentProductsCount ?? 0 }}</div>
                        <div class="text-sm font-medium text-gray-600">Produits en vente</div>
                    </div>
                </div>
                
                <div class="flex-grow"></div>
                <div class="space-y-4 mt-auto">
                    <a href="{{ route('prestataire.urgent-sales.index') }}" class="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-semibold rounded-xl text-white bg-red-600 hover:bg-red-700 transition-all duration-300 shadow-sm hover:shadow-md">
                        <svg class="-ml-1 mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                    ...
                    <a href="{{ route('prestataire.urgent-sales.create') }}" class="w-full inline-flex items-center justify-center px-6 py-3 border border-red-200 text-base font-semibold rounded-xl text-red-700 bg-red-50 hover:bg-red-100 transition-all duration-300">
                        <svg class="-ml-1 mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                        </svg>
