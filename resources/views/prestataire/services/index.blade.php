        ...
        <div class="bg-white rounded-xl shadow-lg border border-blue-200 p-6 mb-8">
            ...
            <form method="GET" action="{{ route('prestataire.services.index') }}" class="flex flex-wrap gap-4" id="filtersForm" style="display: none;">
                <div class="flex-1 min-w-64">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Rechercher par titre..." class="w-full px-3 py-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-blue-900">
                </div>
                
                <div>
                    <select name="category" class="px-3 py-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-blue-900">
