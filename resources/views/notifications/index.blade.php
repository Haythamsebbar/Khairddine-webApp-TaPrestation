            ...
            <div class="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden">
                <div class="divide-y divide-blue-100">
                    @foreach($notifications as $notification)
                        <div class="p-4 sm:p-5 md:p-6 hover:bg-blue-50 transition-colors duration-200 {{ !$notification->read_at ? 'bg-blue-50 border-l-4 border-l-blue-500' : '' }}">
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                                <div class="flex items-start space-x-3 sm:space-x-4 flex-1 min-w-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
                                            ...
                                            @endif
                                            <h3 class="text-sm sm:text-base md:text-lg font-semibold text-blue-900 break-words">
                                                @php
                                        ...
                                        <p class="text-sm text-blue-700 mb-2 leading-relaxed break-words">
                                            @php
                                ...
                                <div class="flex flex-row sm:flex-col md:flex-row items-start gap-2 sm:gap-3 mt-3 sm:mt-0 sm:ml-4 w-full sm:w-auto">
                                    ...
                                    <form action="{{ route('notifications.destroy', $notification) }}" method="POST" class="flex-1 sm:flex-none">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="w-full sm:w-auto inline-flex items-center justify-center px-3 py-2 bg-red-100 hover:bg-red-200 text-red-700 text-xs sm:text-sm font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette notification ?')">
