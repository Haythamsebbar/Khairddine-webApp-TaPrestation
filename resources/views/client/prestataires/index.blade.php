                ...
                @foreach($prestataires as $prestataire)
                    <div class="bg-white rounded-xl shadow-lg border border-blue-200 overflow-hidden hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
                        ...
                        <div class="p-6">
                            ...
                            @if(isset($prestataire->average_rating))
                                <div class="mt-3">
                                    <div class="flex items-center">
                                        <div class="flex items-center">
                                            @for($i = 1; $i <= 5; $i++)
                                                <svg class="w-4 h-4 {{ $i <= round($prestataire->average_rating) ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <p class="ml-1 text-sm text-gray-500">
                                            ...
                                            <span class="text-xs">({{ $prestataire->reviews_count ?? 0 }} avis)</span>
                                        </p>
                                    </div>
                                </div>
                            @endif
